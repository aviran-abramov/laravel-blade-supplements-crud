...
<head>
    ...
    <title>{{ $metaTitle }} | Supplements Project</title>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="{{ route('supplements.index') }}" :active="request()->routeIs('supplements.index')">Supplements</x-nav-link>
                                <x-nav-link href="{{ route('supplements.create') }}" :active="request()->routeIs('supplements.create')">Create</x-nav-link>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6 gap-3">
                            @guest
                                <x-nav-link href="{{ route('session.create') }}" :active="request()->routeIs('session.create')">Login</x-nav-link>
                                <x-nav-link href="{{ route('register.create') }}" :active="request()->routeIs('register.create')">Register</x-nav-link>
                            @endguest
